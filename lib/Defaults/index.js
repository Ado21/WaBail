...
exports.DEFAULT_CONNECTION_CONFIG = {
    ...
    connectTimeoutMs: 10000, // Reduced to 10s for faster fail-over
    keepAliveIntervalMs: 15000, // Increased frequency (15s) for better stability
    logger: logger_1.default.child({ class: 'baileys' }),
    printQRInTerminal: false,
    emitOwnEvents: true,
    defaultQueryTimeoutMs: 30000, // Reduced to 30s
    customUploadHosts: ["https://upload.whatsapp.com"], // Explicit host to skip DNS
    retryRequestDelayMs: 150, // Faster retries (150ms)
    maxMsgRetryCount: 8, // More retries allowed
    ...
    enableAutoSessionRecreation: true, // Enabled for resilience
    enableRecentMessageCache: true, // Enabled for speed
    options: {},
